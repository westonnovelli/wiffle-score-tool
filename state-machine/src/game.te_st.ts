...
import { pitch as logPitch } from './reducer';
...
//     const atBat: atBat = [
//         {
//             pitch: Pitches.INPLAY_INFIELD_OUT,
//             expected: { outs: 1, bases: { [Bases.SECOND]: 1, [Bases.THIRD]: 1, }}
//         },
//     ]
...
//         {
//             pitch: Pitches.BALL,
//             expected: { count: { balls: 1 }, outs: 1, bases: { [Bases.SECOND]: 1, [Bases.THIRD]: 1, }}
//         },
//         {
//             pitch: Pitches.BALL,
//             expected: { count: { balls: 2 }, outs: 1, bases: { [Bases.SECOND]: 1, [Bases.THIRD]: 1, }}
//         },
//         {
//             pitch: Pitches.STRIKE_LOOKING,
//             expected: { outs: 2, bases: { [Bases.SECOND]: 1, [Bases.THIRD]: 1, }}
//         },
//     ]
...
//         {
//             pitch: Pitches.STRIKE_FOUL,
//             expected: { count: { strikes: 1 }, outs: 2, bases: { [Bases.SECOND]: 1, [Bases.THIRD]: 1, }}
//         },
//         {
//             pitch: Pitches.STRIKE_FOUL,
//             expected: { count: { strikes: 2 }, outs: 2, bases: { [Bases.SECOND]: 1, [Bases.THIRD]: 1, }}
//         },
//         {
//             pitch: Pitches.STRIKE_FOUL,
//             expected: { count: { strikes: 2 }, outs: 2, bases: { [Bases.SECOND]: 1, [Bases.THIRD]: 1, }}
...
//             expected: { outs: 2, bases: { [Bases.FIRST]: 1, [Bases.THIRD]: 1, }, boxScore: [{ home: 0, away: 1 }]}
//         },
//     ]
...
// test('6th batter: fly out on 1,0, ends the inning', () => {
//     const atBat: atBat = [
//         {
//             pitch: Pitches.BALL,
//             expected: { count: { balls: 1 }, outs: 2, bases: { [Bases.FIRST]: 1, [Bases.THIRD]: 1, }, boxScore: [{ home: 0, away: 1 }]}

//         },
//         {
//             pitch: Pitches.INPLAY_OUTFIELD_OUT,
//             expected: { inning: { half: InningHalf.BOTTOM }, boxScore: [{ home: 0, away: 1 }] }
//         },
//     ]
